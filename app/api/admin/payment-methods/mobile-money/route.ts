...
// GET - Fetch all mobile money accounts (admin only)
...
// POST - Create new mobile money account (admin only)
export async function POST(req: Request) {
  try {
    ...
    // Validation
    if (!provider_name || !country || !phone_number || !account_name || !network_type || !currency || !fee_structure) {
